...
<!-- Right Side Of Navbar -->
                    ...
                    <li> <a href="#" class="waves-effect"><i class="mdi mdi-format-color-fill fa-fw"></i> <span class="hide-menu">Administração<span class="fa arrow"></span>  </span></a>
                        <ul class="nav nav-second-level">
                            ...
                            <li><a href="panel-ui-block.html"><i data-icon="&#xe025;" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Materias</span></a></li>
                            <li><a href="categorias"><i class="ti-layout-menu fa-fw"></i> <span class="hide-menu">Usuários</span></a></li>
                        </ul>
                 @endif 
            </div>
        </div>
